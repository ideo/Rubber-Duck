...
// ============================================================
// TELYART CRAB — Configuration
// ============================================================
// Telyart ESP32-S3 crab variant. Same pins as telyart duck
// but with crab-specific servo animations (side-to-side, pincers).
...
// Built-in WS2812 RGB LED on GPIO10 for status/mood indication.
// ============================================================
...
// Not used on Waveshare S3 (we use I2S mic), but kept for compatibility.
...
// --- WS2812 LED Config (built-in on Waveshare S3-Zero) ---
#define NEOPIXEL_PIN       10      // GP10 — onboard WS2812 RGB LED
#define NEOPIXEL_COUNT     1       // Single LED

// --- Servo Config (LEDC PWM) ---
#define SERVO_PIN          5       // GP5 on Telyart
...
// --- Button Config ---
#define BUTTON_PIN         4       // GP4 on Telyart
